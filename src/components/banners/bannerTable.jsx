...
const BannerTable = () => {
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          {banners?.map((banner, key) => (
            ...
            >
              ...
              <div className="col-span-2  flex flex-col gap-4 sm:flex-row sm:items-center">
                <p className="pr-5 text-sm text-black dark:text-white">
                  {banner.subtitle}
                </p>
              </div>
              <div className="col-span-2 flex items-center">
              ...
              <div className="col-span-1 flex items-center space-x-3.5">
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    dispatch(fetchBannerByIdAsync(banner.id));
                    setOpenModal(true);
                  }}
                ...
                <Link
                  href={`/banner-form/edit/${banner.id}`}
                  className="hover:text-primary"
                >
                  <svg
                    className="fill-current"
      ...
      {selectedBanner && (
        <Modal
          title={`Delete ${selectedBanner.title}`}
