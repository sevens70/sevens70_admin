...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: (
          <svg width="18" height="19" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Category", route: "/categories" },
        ],
      },
      {
        icon: (
          <svg
            ...
            width="18"
            height="18"
            viewBox="0 0 378.405 378.405"
          >
            <g>
              <g>
                <path
                  d="M340.956,136.203c-21.957-62.74-81.716-107.87-151.857-107.87s-129.9,45.129-151.86,107.87H0.188l22.265,53.703L0,242.203
        ...
        // route: "#",
        children: [
          { label: "Banner list", route: "/banners" },
          { label: "Create Banner", route: "/banner-form" },
        ],
      },
        ...
        icon: (
          ...
          >
            <path
              ...
              fill=""
            />
            <path fill="" d="M2 9h2v1H2zM16 9h2v1h-2z" />
          </svg>
        ),
        label: "Orders",
        route: "/orders",
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen ${pathname.includes("/orders") ? "" : "w-72.5"} flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
